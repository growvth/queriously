...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai::clear_chat_messages,
            commands::ai::generate_marginalia,
            commands::ai::get_marginalia,
            commands::ai::create_marginalia_note,
            commands::ai::update_marginalia_note,
            commands::ai::delete_marginalia_note,
            commands::ai::promote_marginalia_to_annotation,
            ...
            commands::config::check_ai_readiness,
